...
- 500アラートメール確認
	...
	- [x] 夕方
## 差し込みタスク
- [x] [ENEOS_KAWASAKI-1170](https://vqit.backlog.com/view/ENEOS_KAWASAKI-1170) 【本番】【ENEOS川崎】【500エラー】【暫定対応】変換対象にない形式（SVG）の画像をアップロードした際に発生する変換エラー
...
## 優先事項
- [x] [ENEOSCHIBA-54](https://vqit.backlog.com/view/ENEOSCHIBA-54) 千葉：Datadog Organization移行
- [x] [ENEOS_SPM_OOITA-72](https://vqit.backlog.com/view/ENEOS_SPM_OOITA-72) 大分：Datadog Organization設定
- [x] [ENEOSCHIBA-184](https://vqit.backlog.com/view/ENEOSCHIBA-184) 千葉 STGのPLOT図を本番へまるっと移行
- [x] [ENEOS_SPM_OOITA-111](https://vqit.backlog.com/view/ENEOS_SPM_OOITA-111) 大分 STGのPLOT図を本番にコピー
- [ ] 鹿島SlowQuery調査
## 変動作業
- [ ] GithubActionsの導入
## 明日以降
...
- [ ] アプリケーションログの共有
- [ ] セキュリティ対応稼働時間管理シート作成
- [ ] [SPM_INFRA-23](https://vqit.backlog.com/view/SPM_INFRA-23) (1)取得するログの決定
## 変動作業
## 明日以降
...
- [x] セキュリティ対応のスケジュール出し
- [x] 増田さんコメントの確認
- [ ] SSH・DBのユーザー区分・アクセス権・実現方法について増田さんがレビュー可能なコメントを追記する
- [ ] アプリケーションログの共有
- [x] セキュリティ対応稼働時間管理シート作成
- [x] [SPM_INFRA-23](https://vqit.backlog.com/view/SPM_INFRA-23) (1)取得するログの決定
## 変動作業
- [ ] ISO eラーニング
- [x] 情報セキュリティ委員 チェック
## 明日以降
...
## 優先事項
- [x] SSH・DBのユーザー区分・アクセス権・実現方法について増田さんがレビュー可能なコメントを追記する
- [x] remote_ipについて調査
- [x] ログ出力内容の決定
## 変動作業
- [ ] ISO eラーニング
...
- [ ] 増田さんのコメント確認
- [x] cronの出力先変更確認
- [ ] 竹口さんからのコメント確認（実施していると回答した項目についてのコメント）
...
## タスク
- [ ] 増田さんのコメント確認
- [x] 竹口さんからのコメント確認（実施していると回答した項目についてのコメント）
- [ ] 実施済み項目のコメント
...
- [ ] 増田さんのコメント確認
- [x] STGのログ出力設定変更
- [x] マルチアプリでcronの出力をファイル分けできるか調べる
	- [x] やらなくて良い
- [ ] セキュリティ対応請書作成
...
- [ ] ログ外出し
	- [x] 本番反映
		- [x] 本番反映手順作成
	- [x] datadogログ転送の権限設定確認
		- [x] datadogでJSONが綺麗に表示されない
## 明日以降
- [ ] DB audit logの有効化
- [ ] スナップショットの保存期間延長検討
- [ ] IAMの制御
